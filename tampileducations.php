  ...
  <br><br><br><br><br>
        ...
        <table id="listtable" class="table table-striped">
          <thead>
            <tr>
              <th>Code </th>
              <th>Kindergarten </th>
              <th>Kindergarten Content </th>
              <th>Elementary School </th>
              <th>Elementary School Content </th>
              <th>Junior High School </th>
              <th>Junior High School Content </th>
              <th>High School </th>
              <th>High School Content</th>
              <th>College </th>
              <th>College Content </th>
            </tr>
          </thead>
          <body>
    ...
    ?>
            ...
            <tr>
              ...
              <td><?php echo $row["isitk"] ?></td>
              <td><?php echo $row["sd"] ?></td>
              <td><?php echo $row["isisd"] ?></td>
              <td><?php echo $row["smp"] ?></td>
              <td><?php echo $row["isismp"] ?></td>
              <td><?php echo $row["smk"] ?></td>
              <td><?php echo $row["isismk"] ?></td>
              <td><?php echo $row["kuliah"] ?></td>
              <td><?php echo $row["isikuliah"] ?></td>
                <a href="inputeducations.php?id=<?php echo $row["id"] ?>" class="btn btn-info">Edit</a>
              </td>
            </tr>
